...
import { ChevronRight, Zap, Lock, BarChart3, CheckCircle2, ShieldCheck, Sparkles, ArrowRight, Rocket, Brain, FileText, Bot, Crown } from 'lucide-react'
...
const API = process.env.NEXT_PUBLIC_API_URL || 'https://sonoradigitalcorp.com/api'
