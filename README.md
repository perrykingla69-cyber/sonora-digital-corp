...
- Primer corte v2: ingestión, consulta, borrado, métricas y feedback básico sobre memoria persistida en `.data` (configurable con `MEMORY_DATA_DIR`) y preparada para adaptadores futuros.
